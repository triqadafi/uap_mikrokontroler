...
_0x6:
	.DB  0x9A,0x99,0x99,0x3F
_0x0:
	.DB  0x56,0x31,0x3A,0x20,0x25,0x30,0x37,0x2E
	.DB  0x32,0x66,0x20,0x6D,0x56,0x0,0x56,0x32
	.DB  0x3A,0x20,0x25,0x30,0x37,0x2E,0x32,0x66
...
; 0000 0052         v_2 = (read_adc(1)/1024.0) * v_ref * 1000;
	...
	STS  _v_2+2,R22
	STS  _v_2+3,R23
; 0000 0053         sprintf(buff,"V1: %07.2f mV", (v_1<1000)?v_1:1000.00);
	RCALL SUBOPT_0x1
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 0056         lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0057         sprintf(buff,"V2: %07.2f mV", (v_2<1000)?v_2:1000.00);
	RCALL SUBOPT_0x1
	__POINTW1FN _0x0,14
	ST   -Y,R31
	ST   -Y,R30
